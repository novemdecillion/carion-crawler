...
open class CrawledPageRecord() : UpdatableRecordImpl<CrawledPageRecord>(CrawledPageTable.CRAWLED_PAGE), Record8<String?, CrawledStatus?, String?, Boolean?, OffsetDateTime?, OffsetDateTime?, String?, ByteArray?>, ICrawledPage {
    ...
    override fun valuesRow(): Row8<String?, CrawledStatus?, String?, Boolean?, OffsetDateTime?, OffsetDateTime?, String?, ByteArray?> = super.valuesRow() as Row8<String?, CrawledStatus?, String?, Boolean?, OffsetDateTime?, OffsetDateTime?, String?, ByteArray?>
    ...
    override fun field7(): Field<String?> = CrawledPageTable.CRAWLED_PAGE.HTML
    override fun field8(): Field<ByteArray?> = CrawledPageTable.CRAWLED_PAGE.DATA
    ...
    override fun component7(): String? = html
    override fun component8(): ByteArray? = `data`
    ...
    override fun value7(): String? = html
    override fun value8(): ByteArray? = `data`
    ...
    override fun value7(value: String?): CrawledPageRecord {
        this.html = value
        return this
    }

    override fun value8(value: ByteArray?): CrawledPageRecord {
        this.`data` = value
        return this
    }

    override fun values(value1: String?, value2: CrawledStatus?, value3: String?, value4: Boolean?, value5: OffsetDateTime?, value6: OffsetDateTime?, value7: String?, value8: ByteArray?): CrawledPageRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(url: String? = null, status: CrawledStatus? = null, note: String? = null, exclude: Boolean? = null, searchedAt: OffsetDateTime? = null, crawledAt: OffsetDateTime? = null, html: String? = null, `data`: ByteArray? = null): this() {
        this.url = url
        this.status = status
        this.note = note
